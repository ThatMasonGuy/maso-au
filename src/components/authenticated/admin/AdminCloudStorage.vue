    ...
    <Card>
        ...
        <CardContent>
            ...
            <div class="mb-4">
                ...
                <Button class="mt-2" @click="uploadFile" :disabled="!selectedFile">Upload</Button>
            </div>
            <Table>
                <TableHeader>
                    <TableRow>
                ...
                <TableBody>
                    <TableRow v-if="!files.length">
                        <TableCell colspan="3">No files found.</TableCell>
                    </TableRow>
                    <TableRow class="cursor-pointer" v-for="file in files" :key="file.name">
