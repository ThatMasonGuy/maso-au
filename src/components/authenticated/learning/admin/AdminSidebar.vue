<template>
    <div
        ...
        <div class="bg-gray-800 h-full shadow-lg px-3 pt-12 pb-3 overflow-hidden flex flex-col">
            ...
            <div v-show="sidebarOpen" class="text-white mb-6 text-center transition-opacity duration-500 ease-in-out"
            ...
            <nav class="flex-1 justify-start items-start">
                <ul class="space-y-2">
                    ...
                    <li>
                        <button @click.prevent="$router.push('/auth/learning/admin/courses')"
                            class="w-full text-white flex p-2 rounded-md hover:bg-gray-700 hover:shadow-lg transition-all duration-200">
                            <BookOpenIcon class="h-6 w-6" />
                            <span v-show="sidebarOpen" class="ml-4 transition-opacity duration-500"
                                :class="{ 'opacity-0': !sidebarOpen, 'opacity-100': sidebarOpen }">Courses &
                                Sessions</span>
                        </button>
                    </li>
                    <li>
                        <button @click.prevent="$router.push('/auth/learning/admin/users')"
                            class="w-full text-white flex p-2 rounded-md hover:bg-gray-700 hover:shadow-lg transition-all duration-200">
                            <UserIcon class="h-6 w-6" />
                            <span v-show="sidebarOpen" class="ml-4 transition-opacity duration-500"
                                :class="{ 'opacity-0': !sidebarOpen, 'opacity-100': sidebarOpen }">User
                                Management</span>
                        </button>
                    </li>
                    <li>
                        <button @click.prevent="$router.push('/auth/learning/admin/reports')"
                            class="w-full text-white flex p-2 rounded-md hover:bg-gray-700 hover:shadow-lg transition-all duration-200">
                            <ChartBarIcon class="h-6 w-6" />
                            <span v-show="sidebarOpen" class="ml-4 transition-opacity duration-500"
                                :class="{ 'opacity-0': !sidebarOpen, 'opacity-100': sidebarOpen }">Reports &
                                Analytics</span>
                        </button>
                    </li>
                    <li>
                        <button @click.prevent="$router.push('/auth/learning/admin/audit-log')"
                            class="w-full text-white flex p-2 rounded-md hover:bg-gray-700 hover:shadow-lg transition-all duration-200">
                            <ClipboardDocumentListIcon class="h-6 w-6" />
                            <span v-show="sidebarOpen" class="ml-4 transition-opacity duration-500"
                                :class="{ 'opacity-0': !sidebarOpen, 'opacity-100': sidebarOpen }">Audit Log</span>
                        </button>
                    </li>
                    <li>
                        <button @click.prevent="$router.push('/auth/learning/admin/system-health')"
                            class="w-full text-white flex p-2 rounded-md hover:bg-gray-700 hover:shadow-lg transition-all duration-200">
                            <ServerIcon class="h-6 w-6" />
                            <span v-show="sidebarOpen" class="ml-4 transition-opacity duration-500"
                                :class="{ 'opacity-0': !sidebarOpen, 'opacity-100': sidebarOpen }">System Health</span>
                        </button>
                    </li>
                    <li>
                        <button @click.prevent="$router.push('/auth/learning/admin/settings')"
                            class="w-full text-white flex p-2 rounded-md hover:bg-gray-700 hover:shadow-lg transition-all duration-200">
